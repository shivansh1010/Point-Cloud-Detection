...
pip install torch==1.12.0 torchvision --index-url https://download.pytorch.org/whl/cu102
...
pip install torch_geometric==2.3 pyg_lib torch_scatter torch_sparse torch_cluster torch_spline_conv -f https://data.pyg.org/whl/torch-1.12.0+cu102.html
